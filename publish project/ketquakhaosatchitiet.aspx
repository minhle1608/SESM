<%@ Page Title="" Language="C#" MasterPageFile="~/benhvien.master" AutoEventWireup="true" CodeFile="ketquakhaosatchitiet.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    <form id="form1">
                ...
                <br />
                <asp:Label ID="lbltapluyen" runat="server"></asp:Label>

        <asp:GridView ID="grdviewkhaosat" runat="server" AutoGenerateColumns="False" CellPadding="4" GridLines="None" ForeColor="#333333" OnRowCreated="grdviewkhaosat_RowCreated">
