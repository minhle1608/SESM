<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="PhongBan.aspx.cs" Inherits="Admin_PhongBan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div>
        <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="16pt"
            ForeColor="#33CC33" Text="Thông Tin phòng ban "></asp:Label>
        <br />
        <asp:GridView ID="grvPhongBan" runat="server" AutoGenerateColumns="False"
            CellPadding="4" DataKeyNames="MaPhongBan"
            ForeColor="#333333" GridLines="None" PageSize="8">
            <RowStyle BackColor="#EFF3FB" />
            <Columns>
                <asp:BoundField DataField="MaPhongBan" HeaderText="Mã phòng ban " ReadOnly="True"
                    SortExpression="MaPhongBan" />
                <asp:BoundField DataField="TenPhongBan" HeaderText="Tên phòng ban "
                    SortExpression="TenPhongBan" />
            </Columns>
        ...
        <table style="width: 100%; text-align: right;">
            <tr>
                ...
                <th style="width: 150px">
                    <asp:TextBox ID="txtMaPhongBan" runat="server" clientinstancename="txtMaPhongBan" CssClass="InputText"
                        Width="100%">
                    </asp:TextBox>
                </th>
            </tr>
            <tr>
                ...
                <th style="width: 150px">
                    <asp:TextBox ID="txtTenPhongBan" runat="server" clientinstancename="txtTenPhongBan" CssClass="InputText"
                        Width="100%">
                    </asp:TextBox>
                </th>
            </tr>
