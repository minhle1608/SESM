...
public partial class Admin_ketquakhaosat : System.Web.UI.Page
{
    ...
    int namsinh1 = 1990;
    int namsinh2 = DateTime.Now.Year;
    int tochuc = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            binddata(ngaybatdau,ngayketthuc,namsinh1 ,namsinh2 );
          

        }
    }
    private void binddata(DateTime batdau, DateTime ketthuc, int namsinh_1,int namsinh_2)
    {
                
        DataTable dt = Cls_ThreadQuestion.Get_Ketquakhaosat_bieudo_namsinh_thoigian(batdau, ketthuc, namsinh_1,namsinh_2 );
    ...
    protected void btnlocdulieu_Click(object sender, EventArgs e)
    {
        ...
        namsinh1 = int.Parse(txtnam1.Text );
        namsinh2 = int.Parse(txtnam2.Text);
        binddata(ngaybatdau, ngayketthuc, namsinh1,namsinh2 );
