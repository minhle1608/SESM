<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/quantri.master" AutoEventWireup="true" CodeFile="ketquakhaosattheonamsinh.aspx.cs" Inherits="Admin_ketquakhaosat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
        <center>
    THỐNG KÊ KHẢO SÁT TÂM LÝ HỌC ĐƯỜNG THEO ĐỘ TUỔI<br />
    ...
    <asp:TextBox ID="txtngayketthuc" runat="server"  TextMode="Date" Width="137px" ></asp:TextBox>
            ...
            &nbsp;Năm sinh kết thúc:<asp:TextBox ID="txtnam2" runat="server" TextMode="Number" Width="80px"></asp:TextBox><asp:Button ID="btnlocdulieu" runat="server" OnClick="btnlocdulieu_Click" Text="Lọc dữ liệu" />
            <asp:GridView ID="grvkhaosat" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="KetquaID" ForeColor="#333333" GridLines="None" Width="100%" OnRowDataBound="grvkhaosat_RowDataBound" OnSelectedIndexChanged="grvkhaosat_SelectedIndexChanged" AllowPaging="True" EnableSortingAndPagingCallbacks="True" OnPageIndexChanging="grvkhaosat_PageIndexChanging">
