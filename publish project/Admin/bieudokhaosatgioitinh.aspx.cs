...
public partial class Admin_ketquakhaosat : System.Web.UI.Page
{
    ...
    private void binddata(DateTime batdau, DateTime ketthuc, int gioitinh)
    {
                
        DataTable dt = Cls_ThreadQuestion.Get_Ketquakhaosat_bieudo_tochuc_thoigian(batdau, ketthuc, gioitinh);
    ...
    protected void btnlocdulieu_Click(object sender, EventArgs e)
    {
        ...
        gioitinh = int.Parse(ddrGioitinh.SelectedValue);
        binddata(ngaybatdau, ngayketthuc, gioitinh);
