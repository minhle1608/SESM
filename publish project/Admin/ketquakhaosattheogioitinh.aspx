<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/quantri.master" AutoEventWireup="true" CodeFile="ketquakhaosattheogioitinh.aspx.cs" Inherits="Admin_ketquakhaosat" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
        <center>
    THỐNG KÊ KHẢO SÁT TÂM LÝ HỌC ĐƯỜNG THEO GIỚI TÍNH<br />
